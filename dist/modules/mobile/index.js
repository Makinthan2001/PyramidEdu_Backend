...
const fee_routes_1 = __importDefault(require("./fee/routes/fee.routes"));
const profile_routes_1 = __importDefault(require("./profile/routes/profile.routes"));
...
router.use('/attendance', attendance_1.attendanceRoutes);
