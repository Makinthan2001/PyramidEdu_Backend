...
require("./cron/parentReportsCron");
require("./cron/performanceCron");
...
const shutdown = (reason) => {
    ...
    server.close((err) => {
        ...
        Promise.resolve().then(() => __importStar(require('./config/prisma.config'))).then(({ prisma }) => prisma.$disconnect())
            .catch(() => undefined)
